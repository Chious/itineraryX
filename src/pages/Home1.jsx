        ...
        <Box style={{position:'relative'}}>
          <Card elevation={0} style={{borderRadius:'0px'}}>
            ...
            <div style={{
              ...
              width: '100%', 
              height: '100%', 
              background: "linear-gradient(0deg, hsl(205.09,35.48%,30.39%,0.1) 0%, hsl(205.09,35.48%,30.39%,1) 100%)",
            }}/>
            </div>
          </Card>
        ...
        <Box style={{position:'relative'}}>
          ...
          <Box style={{position:'absolute', top:'50%', left:'50%', transform: 'translate(-50%, -50%)', padding:'5vw', width:'90vw'}}>
            <Stack 
              ...
              style={{display: 'flex'}}
            >
              <Typography variant="h4" fontSize='1.5vw' style={{color:'#647680', fontFamily:'Poppins', fontWeight:600 }}>
                Beautiful Places Around The World
              </Typography>
              <Typography variant="h1" fontSize='3vw' style={{color:'#325269', marginTop:'0.5vw',fontFamily:'Poppins', fontWeight:600 }}>
            ...
            <Box style={{position:'relative'}}>
              <Card elevation={0}>
                ...
                <div style={{
                  ...
                  width: '100%', 
                  height: '100%', 
                  background: "linear-gradient(0deg, hsl(205.09,35.48%,30.39%,0.6) 0%, hsl(205.09,35.48%,30.39%,0.6) 100%)",
                }}/>
              </Card>
            ...
            <Box style={{position:'relative'}}>
              <Card elevation={0}>
                <CardMedia          
                  ...
                  title="background"
                  component="img"
                  style={{width:'60vw', height:'60vw', objectFit:'cover', opacity:'0.1', backgroundColor:'#B4C4D9'}}
                />
              </Card>
                    ...
                    <Box style={{position:'absolute', top:'50%', left:'50%', transform: 'translate(0%, -50%)', padding:'5vw', width:'60vw'}}>
                      <Box>
                        <Stack 
                          ...
                          style={{display: 'flex'}}
                        >
                          <Typography variant="h1" fontSize='3.5vw' style={{flex: 1, color:'#325269', textAlign:'left', marginBottom: '40px', fontFamily:'Poppins', fontWeight:600 }}>
                            Our exclusive trip
                          </Typography>
                          <Grid container spacing={0} marginBottom={9}>
                            <Grid item xs={4} style={{display: 'flex'}} justifyContent="center" alignItems="center">
                              <TripCard image={tokyo} name={'Tokyo'} info={'Five day trip'}/>
                            </Grid>
                            <Grid item xs={4} style={{display: 'flex'}} justifyContent="center" alignItems="center">
                              <TripCard image={seoul} name={'Seoul'} info={'Three day trip'}/>
                            </Grid>
                            <Grid item xs={4} style={{display: 'flex'}} justifyContent="center" alignItems="center">
                              <TripCard image={osaka} name={'Osaka'} info={'Six day trip'}/>
                            </Grid>
                          </Grid>
                          <Typography variant="h1" fontSize='2vw' style={{flex: 1, color:'#647680', textAlign:'left', marginBottom: '1vw', fontFamily:'Poppins', fontWeight:600 }}>
                            Your trip helper
                          </Typography>
                          <PlanHelper/>
                        </Stack>
